...
| Peer sync (iroh carrier, HELLO, per-(origin, zone) heads/gap, verify-as-ingest, equiv proofs) | **Built** (2026-07-10: glade 4789177+02e4522, taut c0758b7 NodeHello/Welcome; store chains were ALREADY per-(origin, zone); crypto stubbed-structure-real) | s-sync (reframed) + `glade/dev-docs/GladePeerSyncNotes.md` | Lane R step 3: directory minimal (WorkspaceEntry/ServeClaim, s-discovery E2E); accept-loop wiring |
