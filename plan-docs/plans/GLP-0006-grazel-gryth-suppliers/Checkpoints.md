...
| `grazel1/p1-first-suppliers` | P1 | chat + gwz suppliers live in demo tabs; grazel composes them and serves gryth-ui | demo tabs verified live (two participants); gryth-ui shows chat+gwz panels via glial | S1-S3 done 2026-07-12 (glade-chat 9238d21 · glade-gwz e53c87d · compose grazel cbb19ba + glade 61617d5; atlas 241; Chat+Gwz tabs live-verified). S4 gryth-ui remains |
