...
| --- | --- | --- | --- | --- |
| `grazel1/p0-foundations` | P0 | a supplier can exist: vocab+model doc, F1 live minting, rust wire client, supplier kit, typed manifest + tab chassis, grazel skeleton boots, principals minimal (attribution live in dir.principals) | all repo gates green; two-node live mint + route outside tests; typed-manifest TS compile wall demonstrated | pending |
